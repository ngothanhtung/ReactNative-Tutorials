...
..3. Manual install for Android (Video): https://youtu.be/_7iKm233n_M
..3. Manual install for iOS (Video): https://youtu.be/qiOGMcX6Xtw
4. Send Notification (Google API): https://firebase.google.com/docs/cloud-messaging/http-server-ref
..4. Send a notification (Admin SDK - Cloud Function): https://firebase.google.com/docs/cloud-messaging/admin/send-messages
..4. Manage Topic: https://firebase.google.com/docs/cloud-messaging/admin/manage-topic-subscriptions
