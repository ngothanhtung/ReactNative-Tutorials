      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : null} style={styles.container}>
        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
          ...
          <View style={styles.loginContainer}>
            ...
            {/* GENDER PICKER */}
            <this.PlatformPicker
              selectedValue={this.state.selectedGender == '' ? '-- Please select a gender' : this.state.selectedGender}
              icon={GENDER_ICON}
            ...
            {/* JOB PICKER */}
            <this.PlatformPicker
              selectedValue={this.state.selectedJob == '' ? '-- Please select a job' : this.state.selectedJob}
              icon={JOB_ICON}
