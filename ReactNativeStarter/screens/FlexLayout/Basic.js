...
export default class FlexDirectionBasics extends Component {
  render() {
    return (
      <View style={{ flex: 1 }}>
        <View style={{ flex: 3, flexWrap: 'wrap', flexDirection: 'row', backgroundColor: 'white', justifyContent: 'space-evenly', alignContent: 'stretch', alignItems: 'center' }}>
          <View style={{ width: 70, height: 50, backgroundColor: 'powderblue', alignSelf: 'flex-end' }}></View>
          <View style={{ width: 50, height: 70, backgroundColor: 'skyblue' }}></View>
