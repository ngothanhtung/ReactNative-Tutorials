...
const CustomDrawerNavigator = () => {
  return (
    <Drawer.Navigator drawerPosition='right' drawerContentOptions={{ activeBackgroundColor: '#FF6C44', activeTintColor: '#ffffff', inactiveTintColor: '#111A2C', labelStyle: { fontWeight: '700' } }} drawerContent={(props) => <CustomDrawerContent {...props} />}>
