...
export default class FlexLayoutExamples extends Component {
  render() {
    return (
      <View style={{ flex: 1 }}>
        <View style={{ flex: 6, flexWrap: 'wrap', flexDirection: 'column', backgroundColor: 'yellow', justifyContent: 'space-evenly', alignItems: 'stretch', alignContent: 'center' }}>
          <View style={{ width: 70, height: 50, backgroundColor: 'red', }}></View>
